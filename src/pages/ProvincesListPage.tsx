        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              {items.length === 0 && !isLoading && <tr><td colSpan={2} className="border border-border p-2.5 text-gray-700 dark:text-gray-300" style={{ textAlign: 'center', color: 'var(--muted)' }}>No hay provincias registradas</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
