        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              {recipients.map((r) => (
                <tr key={r.id}>
                  <td className="border border-gray-200 dark:border-gray-700 p-2.5 text-gray-700 dark:text-gray-300">{r.fullName}</td>
                  <td className="border border-gray-200 dark:border-gray-700 p-2.5 text-gray-700 dark:text-gray-300">{r.idCard}</td>
                  <td className="border border-gray-200 dark:border-gray-700 p-2.5 text-gray-700 dark:text-gray-300">{r.phone || '—'}</td>
                  <td className="border border-gray-200 dark:border-gray-700 p-2.5 text-gray-700 dark:text-gray-300">
                    <div className="flex gap-2 flex-wrap">
                      ...
                      <button type="button" className="bg-transparent text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700 rounded-xl px-2.5 py-2 text-xs cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors" onClick={() => handleDelete(r.id)}>Eliminar</button>
                    </div>
                  </td>
                </tr>
              ))}
