        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              {items.length === 0 && !isLoading && <tr><td colSpan={3} className="border border-gray-200 dark:border-gray-700 p-2.5 text-gray-700 dark:text-gray-300" style={{ textAlign: 'center', color: 'var(--muted)' }}>No hay agencias registradas</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
